      ...
      <div className="homepage-center-trends ">
        <div className="homepage-center-current-trend px-3 py-3 cursor-pointer flex items-center justify-between">
          <div className="homepage-center-current-trend-info">
            ...
            <p className="trend-topic font-bold">Mercy Chinwo</p>
        ...
        <div className="homepage-center-current-trend px-3 py-3 cursor-pointer flex items-center justify-between">
          <div className="homepage-center-current-trend-info">
            <p className="trend-category text-sm">Music . Trending</p>
            <p className="trend-topic font-bold">Asiwaju Bola Ahmed Tinubu</p>
        ...
        <div className="homepage-center-current-trend px-3 py-3 cursor-pointer flex items-center justify-between">
          <div className="homepage-center-current-trend-info">
            <p className="trend-category text-sm">Music . Trending</p>
            <p className="trend-topic font-bold">Katsina</p>
        ...
        <div className="homepage-center-current-trend px-3 py-3 cursor-pointer flex items-center justify-between">
          <div className="homepage-center-current-trend-info">
            <p className="trend-category text-sm">Music . Trending</p>
            <p className="trend-topic font-bold">Yul Edochie</p>
        ...
        <div className="homepage-center-current-trend px-3 py-3 cursor-pointer flex items-center justify-between">
          <div className="homepage-center-current-trend-info">
            <p className="trend-category text-sm">Music . Trending</p>
            <p className="trend-topic font-bold">Rest In Peace</p>
