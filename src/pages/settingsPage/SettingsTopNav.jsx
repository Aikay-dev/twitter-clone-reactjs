...
const SettingsTopNav = ({ navText }) => {
  return (
    <div className="personalization-and-data-head-nav flex text-lg items-center mt-1 mb-6">
      <div className="personalization-and-data-head-nav-arrow-holder flex items-center justify-center cursor-pointer rounded-full h-8 w-8 ml-2 mt-2 mr-8" onClick={() => window.history.back()}>
